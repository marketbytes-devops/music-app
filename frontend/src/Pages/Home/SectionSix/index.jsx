...
const SectionSix = () => {
  ...
  return (
    <div className="w-full bg-white md:py-4 py-2 px-0">
      <div className="container mx-auto">
        ...
        <h2 className="text-[#1B1B1A] text-center font-bold md:mb-8 mb-4">
        ...
        <div className="overflow-hidden" ref={emblaRef}>
          <div className="flex">
            {allSlides.map((t, i) => (
              <div key={i} className="flex-shrink-0 w-full md:px-4 px-1">
                {/* MOBILE */}
                <div className="lg:hidden">
                  <div className="bg-[#F5F5F5] rounded-3xl overflow-hidden">
                    <div className="p-8 pb-6">
                      <h3 className=" font-bold text-gray-900 mb-3">{t.name}</h3>
